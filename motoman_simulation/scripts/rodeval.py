...
a_global = np.array([0, 0, 0, 0, 0, 0]) #[3.9632, 3.0471, 4.4825, -22.019, -0.9381, 28.248]
...
class rod():
    ...
    def __init__(self, c=[1., 1., 1.], L=1, check_collision=False, check_stable=False):
        self.c = np.array(c)
        self.L = L
...
def get_rod_points(a=a_global, plot=False, stabillity_check=False, collision_check=False, c=[0.77, 1., 1.], l=1.45722639): #1.472, 0.8485, 0.998 last best, 0.2242, 2.982, 2.982 theoretical, 1.50279321 last_best2: 0.85676583 1.00830592 1.30585477
    R = rod(L=l, check_stable=stabillity_check, check_collision=collision_check, c=c) #1.45222638, 0.63511371, 1.93133439, 1.47064562
